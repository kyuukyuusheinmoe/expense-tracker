...
export const IconColorMapper = ( payment)=> {
    switch(payment) {
        ...
        case NECESSITY_LOW: return {icon: 'pi pi-money-bill', color: '!bg-error !border-error !text-black'}
        case NECESSITY_MODERATE: return {icon: 'pi pi-credit-card', color: '!bg-warning !border-warning !text-black'}
        case NECESSITY_HIGH: return {icon: "pi pi-mobile", color: "!bg-success !border-success !text-black"}
